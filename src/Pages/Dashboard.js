      ...
      <div className={`mainGrid ${showNav ? 'nav-active' : ''}`} ref={mainGridRef}>
          ...
          <div className='column column3'>
            <MagicBento className='tasksWidget' enableSpotlight={false}>
              ...
              <div style={{display: addTaskForm}} title='تایید' class="editButton" onClick={() =>{setaddTaskForm(addTaskForm === "flex" ? "none" : "flex");settasksChekbox(tasksChekbox === "none" ? "flex" : "none")}}>
              ...
              <div style={{display: tasksChekbox}} title='افزودن' class="editButton" onClick={() =>{setaddTaskForm(addTaskForm === "flex" ? "none" : "flex");settasksChekbox(tasksChekbox === "none" ? "flex" : "none")}}>
