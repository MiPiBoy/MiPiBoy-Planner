...
const AppHeader = ({ handleClick, hideMenuSection }) => {
    ...
    return (
        ...
        {!hideMenuSection && (
        <GlassSurface width="600px" className="" backgroundOpacity={0.1} saturation={1} borderWidth={0.07} brightness={50} opacity={0.93} blur={11} borderRadius={50} displace={0.5} distortionScale={-180} redOffset={0} greenOffset={10} blueOffset={20} mixBlendMode="screen" >
            <div className="input-wrapper">
                <img className="icon" src={quixieIcon}></img>
                <input type="text" name="text" className="input" placeholder="Quixie makes it quick."/>
        ...
        {!hideMenuSection && (
        <div className="headeritem logoSection" backgroundOpacity={0.1} saturation={1} borderWidth={0.07} brightness={50} opacity={0.93} blur={11} borderRadius={50} displace={0.5} distortionScale={-180} redOffset={0} greenOffset={10} blueOffset={20} mixBlendMode="screen" >
